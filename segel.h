...
typedef enum overload_handling_t
{
    BLOCK, DROP_TAIL, DROP_HEAD, DROP_RANDOM
}OVERLOAD_HANDLING;
...
typedef struct queue_t{
    ...
    void* (*removeFromPos)(void*, int);
}*Queue;

typedef struct handle_thread_params_t{
    Queue q;
    int t_id;
}*HTParams;
...
typedef struct solo_q_params_t{
        Queue q;
        int sd;
        struct timeval arrival;
}*QParams;
